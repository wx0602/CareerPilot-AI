  ...
  <main class="login-page">
    <section class="login-pitch">
      ...
      <div class="pitch-copy">
        ...
        <ul class="feature-list">
          <li><b>⌘</b><span><strong>全真场景模拟</strong><small>覆盖笔试、面试、群面等多种真实场景</small></span></li>
    ...
    <section class="login-stage">
      ...
      <form class="login-card" @submit.prevent="enter(false)">
        <h2>账号登录</h2>
        <label>邮箱 / 手机号<input v-model="account" type="text" placeholder="请输入邮箱或手机号" /></label>
        ...
        <button class="guest-button" type="button" @click="enter(true)"><AppIcon name="practice" />游客模式进入<small>无需注册，快速体验</small></button>
