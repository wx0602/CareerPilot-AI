...
<style scoped>
.simulation-page { min-height: 100vh; padding: 34px; color: #1e2b3e; background: radial-gradient(circle at 75% 0, #e4f1ed 0, transparent 33%), #f2f5f3; }
...
.simulation-header { display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; max-width: 1180px; margin: 0 auto 26px; }
...
.simulation-workspace { display: grid; grid-template-columns: 220px minmax(0, 1fr); max-width: 1180px; height: calc(100vh - 140px); min-height: 660px; margin: auto; overflow: hidden; border: 1px solid #dce5df; border-radius: 24px; background: #fff; box-shadow: 0 20px 70px rgba(36,58,48,.1); }
...
@media(max-width:900px){.simulation-page{padding:20px 12px}.simulation-header{grid-template-columns:1fr auto}.simulation-header>div:nth-child(2){text-align:right}.session-state{display:none}.session-connecting{min-height:460px;padding:35px 22px}.simulation-workspace{grid-template-columns:1fr;height:auto;min-height:800px}.stage-rail{display:none}.discussion-panel{min-height:780px;padding:20px 16px}.stress-interview-workspace .discussion-panel{padding-top:0}.discussion-message{max-width:92%}}
</style>
